...
class CP_RequestHandler(BaseRequestHandler):
    ...
    menu: str = """EC2 Server instance
        ...
        2. Commnad: (text sumary     [.txt, .png, .jpg, .jpeg]) "ts [input_file] [output_file]"
        3. Commnad: (text tranlation [.txt, .png, .jpg, .jpeg]) "tt [input_file] [output_file] [LANG_ID]"
